...
export const functionDeclarations: FunctionDeclaration[] = [
  ...
  },
  {
    ...
    description:
      "Obtiene los detalles completos de una receta específica incluyendo ingredientes, pasos de preparación y tiempo",
    parameters: {
      type: Type.OBJECT,
      properties: {
        recipe_name: {
  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        query: {
          type: Type.STRING,
          description: "Término de búsqueda (nombre de receta o ingrediente)",
        },
      },
      required: ["query"],
    },
  ...
  },
  {
    ...
    description:
      "Obtiene los ingredientes que faltan para preparar una receta específica comparando con el inventario actual",
    parameters: {
      type: Type.OBJECT,
      properties: {
        recipe_name: {
          type: Type.STRING,
          description: "Nombre de la receta para verificar ingredientes",
        },
      },
      required: ["recipe_name"],
    },
  },
  {
    name: "suggest_recipe",
    description:
      "Sugiere una receta basada en los ingredientes disponibles en el inventario",
    parameters: {
      type: Type.OBJECT,
      properties: {
        preferences: {
          type: Type.STRING,
          description:
            'Preferencias opcionales (ej: "algo ligero", "con pollo")',
        },
        meal_type: {
          type: Type.STRING,
  ...
  // CONSULTAS - Hogar
  {
    ...
    description:
      "Obtiene las tareas programadas para hoy de todos los empleados",
    parameters: { type: Type.OBJECT, properties: {}, required: [] },
  },
  {
    name: "get_employee_schedule",
    description:
      "Obtiene el horario de un empleado específico para hoy o esta semana",
    parameters: {
      type: Type.OBJECT,
      properties: {
        employee_name: {
          type: Type.STRING,
          description: "Nombre del empleado (ej: Yolima, John)",
        },
        period: {
          type: Type.STRING,
          description: "Período a consultar (today o week)",
        },
      },
  ...
  },
  {
    ...
    description:
      "Obtiene un resumen del progreso de tareas (completadas, pendientes, porcentaje)",
    parameters: { type: Type.OBJECT, properties: {}, required: [] },
  },
  // ============================================
  // ACCIONES - Recetario
  // ============================================
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        quantity: {
          type: Type.STRING,
          description: 'Cantidad (ej: "2 kg", "500g", "3 unidades")',
        },
      },
      required: ["item_name"],
    },
  },
  {
    ...
    description:
      "Agrega todos los ingredientes faltantes de una receta a la lista de compras",
    parameters: {
      type: Type.OBJECT,
      properties: {
  ...
  },
  {
    ...
    description:
      "Cambia la receta de un día específico del menú por otra receta",
    parameters: {
      type: Type.OBJECT,
      properties: {
        day_number: {
          type: Type.NUMBER,
          description: "Número del día del ciclo (1-12)",
        },
        meal_type: {
          type: Type.STRING,
          description: "Tipo de comida: breakfast, lunch o dinner",
        },
        new_recipe_name: {
          type: Type.STRING,
          description: "Nombre de la nueva receta",
        },
      },
    ...
    parameters: {
      ...
      properties: {
        ...
        action: {
          type: Type.STRING,
          description:
            'Acción: "set" para establecer valor, "add" para sumar, "subtract" para restar',
        },
      },
  ...
  // ACCIONES - Hogar
  {
    ...
    parameters: {
      ...
      properties: {
        task_name: {
          type: Type.STRING,
          description: "Nombre o descripción de la tarea",
        },
        employee_name: {
          type: Type.STRING,
  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        category: {
          type: Type.STRING,
          description: "Categoría (limpieza, cocina, lavandería, etc.)",
        },
      },
      required: ["task_name"],
    },
  ...
  // ============================================
  {
    ...
    description:
      "Genera un reporte semanal con resumen de tareas completadas, comidas preparadas y estado del inventario",
    parameters: { type: Type.OBJECT, properties: {}, required: [] },
  },
  {
    name: "get_low_inventory_alerts",
    description:
      "Obtiene alertas de ingredientes con bajo inventario que necesitan reponerse",
    parameters: {
      type: Type.OBJECT,
      properties: {
        threshold: {
          type: Type.NUMBER,
          description: "Cantidad mínima para considerar bajo (default: 2)",
        },
      },
      required: [],
    },
  },
  {
    ...
    description:
      "Obtiene las próximas comidas programadas para los siguientes días",
    parameters: {
      type: Type.OBJECT,
      properties: {
        days: {
          type: Type.NUMBER,
          description: "Número de días a consultar (default: 3)",
        },
      },
      required: [],
    },
  ...
  // ============================================
  {
    ...
    description:
      "Obtiene información de la fecha actual (día, semana del ciclo, etc.)",
    parameters: { type: Type.OBJECT, properties: {}, required: [] },
  },
  {
    name: "calculate_portions",
    description:
      "Calcula las cantidades de ingredientes ajustadas para un número específico de porciones",
    parameters: {
      type: Type.OBJECT,
      properties: {
        recipe_name: { type: Type.STRING, description: "Nombre de la receta" },
  ...
  },
  {
    ...
    description:
      "Obtiene consejos y preparaciones previas necesarias para las comidas del día",
    parameters: { type: Type.OBJECT, properties: {}, required: [] },
  },
  // ============================================
  // AGENTE MULTI-PASO
...
La función ejecutará automáticamente todos los pasos necesarios y reportará el progreso.`,
    parameters: {
      ...
      properties: {
        task_type: {
          type: Type.STRING,
          description:
            'Tipo de tarea: "prepare_recipe", "weekly_planning", "shopping_optimization", "full_report", "menu_from_inventory"',
        },
        params: {
          type: Type.OBJECT,
          description:
            'Parámetros específicos de la tarea (ej: {recipe_name: "Arroz con pollo"} para prepare_recipe)',
        },
      },
      required: ["task_type"],
    },
  },
  {
    ...
    description:
      "Genera una lista de compras inteligente basada en el menú de los próximos días y el inventario actual",
    parameters: {
      type: Type.OBJECT,
      properties: {
        days_ahead: {
          type: Type.NUMBER,
          description: "Número de días a planificar (default: 7)",
        },
      },
      required: [],
    },
  ...
  // ============================================
  {
    name: "list_spaces",
    description:
      "Obtiene la lista de todos los espacios configurados en el hogar (cocina, baños, habitaciones, etc.)",
    parameters: { type: Type.OBJECT, properties: {}, required: [] },
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        space_name: {
          type: Type.STRING,
          description: "Nombre del espacio (alternativa a space_id)",
        },
      },
      required: [],
    },
  },
  {
    name: "create_space",
    description:
      "Crea un nuevo espacio en el hogar. Requiere confirmación del usuario.",
    parameters: {
      type: Type.OBJECT,
      properties: {
        name: {
          type: Type.STRING,
          description:
            'Nombre del espacio (ej: "Cocina principal", "Baño master")',
        },
        space_type: {
          type: Type.STRING,
          description:
            "Tipo de espacio: kitchen, bedroom, bathroom, living_room, dining_room, garage, garden, laundry, office, storage, other",
        },
        category: {
          type: Type.STRING,
          description: "Categoría: common_area, private, service, outdoor",
        },
        usage_level: {
          type: Type.STRING,
          description: "Nivel de uso: high, medium, low",
        },
        has_bathroom: {
          type: Type.BOOLEAN,
          description: "Si el espacio tiene baño incluido (para habitaciones)",
        },
        area_sqm: {
          type: Type.NUMBER,
        ...
        notes: {
          type: Type.STRING,
          description: "Notas adicionales sobre el espacio",
        },
      },
  ...
  },
  {
    name: "update_space",
    description:
      "Actualiza la información de un espacio existente. Requiere confirmación del usuario.",
    parameters: {
      type: Type.OBJECT,
      properties: {
        space_id: {
  ...
  },
  {
    name: "delete_space",
    description:
      "Elimina un espacio del hogar. ACCIÓN CRÍTICA: requiere confirmación explícita y no se puede deshacer fácilmente.",
    parameters: {
      type: Type.OBJECT,
      properties: {
        space_id: {
        ...
        confirm: {
          type: Type.BOOLEAN,
          description: "Confirmación explícita de eliminación",
        },
      },
  ...
  // ============================================
  {
    ...
    parameters: {
      ...
      properties: {
        active_only: {
          type: Type.BOOLEAN,
          description: "Solo mostrar empleados activos (default: true)",
        },
      },
      required: [],
    },
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        employee_name: {
          type: Type.STRING,
          description: "Nombre del empleado (alternativa a employee_id)",
        },
      },
      required: [],
    },
  },
  {
    ...
    description:
      "Registra un nuevo empleado en el hogar. Requiere confirmación del usuario.",
    parameters: {
      type: Type.OBJECT,
      properties: {
        name: {
        ...
        role: {
          type: Type.STRING,
          description:
            "Rol: empleada_domestica, niñera, jardinero, conductor, cocinero, cuidador, mantenimiento, seguridad, otro",
        },
        zone: { type: Type.STRING, description: "Zona de trabajo principal" },
        work_days: {
          type: Type.ARRAY,
          items: { type: Type.STRING },
          description: 'Días de trabajo: ["lunes", "martes", ...]',
        },
        hours_per_day: {
          type: Type.NUMBER,
        ...
        schedule: {
          type: Type.STRING,
          description: 'Horario (ej: "8:00 AM - 4:00 PM")',
        },
  ...
  },
  {
    ...
    description:
      "Actualiza la información de un empleado. Requiere confirmación del usuario.",
    parameters: {
      type: Type.OBJECT,
      properties: {
        employee_id: {
        ...
        work_days: {
          type: Type.ARRAY,
          items: { type: Type.STRING },
          description: "Nuevos días de trabajo",
        },
        hours_per_day: {
          type: Type.NUMBER,
          description: "Nuevas horas por día",
        },
  ...
  },
  {
    ...
    description:
      "Elimina o desactiva un empleado. ACCIÓN CRÍTICA: requiere confirmación explícita.",
    parameters: {
      type: Type.OBJECT,
      properties: {
        employee_id: { type: Type.STRING, description: "ID del empleado" },
        hard_delete: {
          type: Type.BOOLEAN,
          description: "Eliminar permanentemente (false = solo desactivar)",
        },
  ...
  // ============================================
  {
    ...
    description:
      "Obtiene la lista de plantillas de tareas recurrentes del hogar",
    parameters: {
      type: Type.OBJECT,
      properties: {
        employee_id: {
        ...
        week_number: {
          type: Type.NUMBER,
          description: "Filtrar por semana del ciclo 1-4 (opcional)",
        },
        category: {
          type: Type.STRING,
  ...
  },
  {
    ...
    description:
      "Crea una nueva plantilla de tarea recurrente. Requiere confirmación.",
    parameters: {
      type: Type.OBJECT,
      properties: {
        employee_name: {
        ...
        week_number: {
          type: Type.NUMBER,
          description: "Semana del ciclo (1-4)",
        },
        day_of_week: {
          type: Type.NUMBER,
        ...
        category: {
          type: Type.STRING,
          description:
            "Categoría: cocina, limpieza, lavanderia, perros, piscina, jardin, etc.",
        },
        is_special: {
          type: Type.BOOLEAN,
          description: "Si es una tarea especial (★)",
        },
        description: {
          type: Type.STRING,
  ...
  },
  {
    ...
    description:
      "Actualiza una plantilla de tarea existente. Requiere confirmación.",
    parameters: {
      type: Type.OBJECT,
      properties: {
        template_id: {
        ...
        employee_name: {
          type: Type.STRING,
          description: "Nuevo empleado asignado",
        },
  ...
  },
  {
    ...
    description:
      "Reprograma una tarea para otro horario o día. Requiere confirmación.",
    parameters: {
      type: Type.OBJECT,
      properties: {
        task_id: {
          type: Type.STRING,
          description: "ID de la instancia de tarea",
        },
        new_date: {
          type: Type.STRING,
          description: "Nueva fecha (formato YYYY-MM-DD)",
        },
        new_time_start: {
          type: Type.STRING,
        ...
        new_time_end: {
          type: Type.STRING,
          description: "Nueva hora de fin (HH:MM)",
        },
        new_employee_name: {
          type: Type.STRING,
          description: "Nuevo empleado (opcional)",
        },
      },
      required: ["task_id"],
    },
  },
  {
    ...
    description:
      "Genera las tareas programadas para una fecha específica basándose en las plantillas",
    parameters: {
      type: Type.OBJECT,
      properties: {
        date: {
          type: Type.STRING,
          description: "Fecha para generar tareas (formato YYYY-MM-DD)",
        },
      },
      required: ["date"],
    },
  ...
  // ============================================
  {
    name: "create_recipe",
    description:
      "Crea una nueva receta en el recetario. Requiere confirmación.",
    parameters: {
      type: Type.OBJECT,
      properties: {
        ...
        difficulty: {
          type: Type.STRING,
          description: "Dificultad: fácil, media o difícil",
        },
        description: {
          type: Type.STRING,
  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        cook_time: {
          type: Type.NUMBER,
          description: "Nuevo tiempo de cocción",
        },
  ...
  },
  {
    name: "delete_recipe",
    description:
      "Elimina una receta del recetario. ACCIÓN CRÍTICA: no se puede deshacer.",
    parameters: {
      type: Type.OBJECT,
      properties: {
        recipe_id: {
  ...
  // ============================================
  {
    ...
    description:
      "Actualiza múltiples items del inventario de una vez. ACCIÓN CRÍTICA.",
    parameters: {
      type: Type.OBJECT,
      properties: {
        updates: {
          ...
          items: {
            ...
            properties: {
              ...
              action: {
                type: Type.STRING,
                description: "Acción: set, add, subtract",
              },
            },
          },
          description:
            "Lista de actualizaciones: [{item_name, quantity, action}]",
        },
        confirm: { type: Type.BOOLEAN, description: "Confirmación explícita" },
      },
  ...
  },
  {
    ...
    description:
      "Procesa una lista de items de un ticket de compra y actualiza el inventario",
    parameters: {
      type: Type.OBJECT,
      properties: {
        items: {
          ...
          items: {
            ...
            properties: {
              ...
              unit: {
                type: Type.STRING,
                description: "Unidad (kg, g, unidades, etc.)",
              },
            },
          },
  ...
  },
  {
    ...
    description:
      "Reinicia todo el inventario a valores predeterminados. ACCIÓN CRÍTICA.",
    parameters: {
      type: Type.OBJECT,
      properties: {
        confirm: { type: Type.BOOLEAN, description: "Confirmación explícita" },
