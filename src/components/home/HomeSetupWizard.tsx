...
export default function HomeSetupWizard({
    ...
    if (data) {
      setSpaceTypes(
        data.map((st) => ({
          ...st,
          default_tasks:
            typeof st.default_tasks === "string"
  ...
  const generateDefaultTasks = async (householdId: string) => {
    ...
    for (const space of spaces) {
      ...
      const tasks =
        typeof spaceType.default_tasks === "string"
      ...
      const baseFrequency =
        frequencyMap[space.usage_level as keyof typeof frequencyMap] ||
        "semanal";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
          ...
          <div className="space-y-6">
            <div className="text-center py-8">
              ...
              <p className="text-gray-600">
                Vamos a crear el perfil de tu hogar para organizar las tareas de
                limpieza
              </p>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-3">
              {interiorTypes.map((spaceType) => {
                const selected = selectedInterior.find(
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-3">
              {exteriorTypes.map((spaceType) => {
                const selected = selectedExterior.find(
                  (s) => s.spaceTypeId === spaceType.id,
                );
                return (
                  <div
              ...
              {employees.map((emp, index) => (
                <div key={index} className="bg-white rounded-xl p-4 shadow-sm">
                  ...
                  <div className="mb-3">
                    ...
                    <div className="flex gap-2">
                      {(["interior", "exterior", "ambos"] as const).map(
                        (zone) => (
                          <button
                            key={zone}
            ...
            <div className="bg-white rounded-xl p-4 shadow-sm">
              ...
              <div className="space-y-2">
                {selectedInterior.map((s) => (
                  ...
                  >
                    <span>
                      {s.spaceType.icon} {s.spaceType.name}{" "}
      ...
      {/* Navigation Footer */}
      <div className="fixed bottom-20 left-0 right-0 bg-white border-t p-4 shadow-lg z-20">
