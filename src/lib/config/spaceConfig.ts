...
export const ATTRIBUTE_TASKS: Record<keyof SpaceAttributes, TaskConfig[]> = {
  has_bathroom: [
    {
      name: "Limpiar sanitario",
      frequency: "diaria",
      enabled: true,
      estimatedMinutes: 10,
      requiresAttribute: "has_bathroom",
    },
    {
      name: "Limpiar lavamanos",
      frequency: "diaria",
      enabled: true,
      estimatedMinutes: 5,
      requiresAttribute: "has_bathroom",
  ...
  has_walkin_closet: [
    {
      name: "Organizar walking closet",
      frequency: "mensual",
      enabled: true,
      estimatedMinutes: 45,
      requiresAttribute: "has_walkin_closet",
    },
    {
      name: "Barrer walking closet",
      frequency: "semanal",
      enabled: true,
      estimatedMinutes: 10,
      requiresAttribute: "has_walkin_closet",
  ...
  has_balcony: [
    {
      ...
      enabled: true,
      estimatedMinutes: 10,
      requiresAttribute: "has_balcony",
    },
    {
      name: "Limpiar baranda balcón",
      frequency: "quincenal",
      enabled: true,
      estimatedMinutes: 10,
      requiresAttribute: "has_balcony",
  ...
  has_curtains: [
    {
      name: "Limpiar cortinas",
      frequency: "mensual",
      enabled: true,
      estimatedMinutes: 20,
      requiresAttribute: "has_curtains",
    },
    {
      name: "Aspirar cortinas",
      frequency: "quincenal",
      enabled: false,
      estimatedMinutes: 15,
      requiresAttribute: "has_curtains",
  ...
  has_air_conditioning: [
    {
      name: "Limpiar filtros A/C",
      frequency: "quincenal",
      enabled: true,
      estimatedMinutes: 15,
      requiresAttribute: "has_air_conditioning",
    },
    {
      name: "Limpiar rejillas A/C",
      frequency: "mensual",
      enabled: true,
      estimatedMinutes: 10,
      requiresAttribute: "has_air_conditioning",
...
export const DEFAULT_TASKS: Record<string, TaskConfig[]> = {
  sala: [
    ...
    {
      name: "Sacudir muebles",
      frequency: "semanal",
      enabled: true,
      estimatedMinutes: 15,
    },
    {
      name: "Limpiar vidrios/ventanas",
      frequency: "quincenal",
      enabled: true,
      estimatedMinutes: 20,
    },
    {
      name: "Limpiar marcos y puertas",
      frequency: "mensual",
      enabled: true,
      estimatedMinutes: 15,
    },
  ...
  cocina: [
    ...
    {
      name: "Limpiar campana extractora",
      frequency: "quincenal",
      enabled: true,
      estimatedMinutes: 20,
    },
    {
      name: "Limpiar nevera por fuera",
      frequency: "semanal",
      enabled: true,
      estimatedMinutes: 10,
    },
    {
      name: "Limpiar nevera por dentro",
      frequency: "quincenal",
      enabled: true,
      estimatedMinutes: 30,
    },
    {
      name: "Limpiar horno/microondas",
      frequency: "semanal",
      enabled: true,
      estimatedMinutes: 20,
    },
  ...
  baño: [
    ...
    {
      name: "Limpiar azulejos",
      frequency: "quincenal",
      enabled: true,
      estimatedMinutes: 20,
    },
    {
      name: "Organizar productos",
      frequency: "mensual",
      enabled: true,
      estimatedMinutes: 15,
    },
  ...
  lavandería: [
    ...
    {
      name: "Limpiar lavadora",
      frequency: "quincenal",
      enabled: true,
      estimatedMinutes: 20,
    },
    {
      name: "Limpiar secadora",
      frequency: "quincenal",
      enabled: true,
      estimatedMinutes: 15,
    },
  ...
  terraza: [
    ...
    {
      name: "Limpiar muebles",
      frequency: "semanal",
      enabled: true,
      estimatedMinutes: 15,
    },
    {
      name: "Limpiar barandas",
      frequency: "quincenal",
      enabled: true,
      estimatedMinutes: 15,
    },
...
export function getDefaultTasksForType(
  typeName: string,
  attributes?: SpaceAttributes,
): TaskConfig[] {
